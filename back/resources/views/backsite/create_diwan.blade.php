...
@section('content')
    ...
    <body>
        <div class="container" dir="rtl">
            <!-- Content here -->
            @if (count($diwan) == 0)
                <form method="POST" action="{{ route('diwan-store') }}" enctype="multipart/form-data">
                    @csrf
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link disabled" href="{{ route('diwan-edit') }}">التعديل</a>
                        </li>
                    </ul>
                    <br>
                    <br>
            ...
            @else
                <form method="POST" action="{{ route('diwan-store') }}" enctype="multipart/form-data">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('diwan-edit') }}">التعديل</a>
                        </li>
                    </ul>
                    <br>
                    <br>
