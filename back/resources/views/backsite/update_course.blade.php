        ...
        <div class="container" dir="rtl">
            ...
            <form method="POST" action="{{ route('course-update') }}" enctype="multipart/form-data">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('course-post') }}">الاضافة</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="about" class="form-control" id="exampleFormControlTextarea1" rows="8" placeholder="ادخل النص"> {{ $course[0]->about }}</textarea>
                    </div>
                            ...
                            @foreach ($course_image as $image)
                                <tr>
                                    ...
                                    <td style="padding-top: 42px"><a
                                            href="{{ url('admin/course-image/edit/' . $image->id) }}"
                    ...
                    <br>
                    <input type="hidden" name="hidden_id" value="{{ $course[0]->id }}">
...
@section('title')
    تعديل  قسم الدورات والتجويد والأسانيد
@endsection
