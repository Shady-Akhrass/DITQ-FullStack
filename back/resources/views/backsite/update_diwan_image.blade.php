...
@section('content')
    ...
    <head>
        ...
        <title> تعديل صور ديوان الحفاظ</title>
    </head>
    ...
    <body>
        <div class="container" dir="rtl">
            ...
            <form method="POST" action="{{ route('diwan-image-update') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <br>
                <div>
                    <input type="hidden" name="hidden_id" value="{{ $diwan_image->id }}">
                </div>
