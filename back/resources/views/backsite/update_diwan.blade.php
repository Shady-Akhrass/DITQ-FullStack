...
@section('content')
    ...
    <body>
        <div class="container" dir="rtl">
            ...
            <form method="POST" action="{{ route('diwan-update') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('diwan-post') }}">الاضافة</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="about" class="form-control" id="exampleFormControlTextarea1" rows="8" placeholder="ادخل النص"> {{ $diwan[0]->about }}</textarea>
                    </div>
                            ...
                            @foreach ($diwan_image as $image)
                                <tr>
                                    ...
                                    <td style="padding-top: 42px"><a
                                            href="{{ url('admin/diwan-image/edit/' . $image->id) }}"
                    ...
                    <br>
                    <input type="hidden" name="hidden_id" value="{{ $diwan[0]->id }}">
