        ...
        <div class="container" dir="rtl">
            ...
            <form method="POST" action="{{ route('activity-update') }}" enctype="multipart/form-data">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('activity-post') }}">الاضافة</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="about" class="form-control" id="exampleFormControlTextarea1" rows="8" placeholder="ادخل النص" > {{ $activity[0]->about }}</textarea>
                    </div>
                    ...
                    <br>
                    <input type="hidden" name="hidden_id" value="{{ $activity[0]->id }}">
